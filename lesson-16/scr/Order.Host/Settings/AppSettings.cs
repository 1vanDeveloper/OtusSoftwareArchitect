...
namespace Order.Host.Settings
{
    ...
    internal class AppSettings : IAppSettings
    {
        public AppSettings(IConfiguration configuration)
        {
            ...
            BillingServiceUrl = configuration.GetValue<string>("BILLING_SERVICE_URL");
        ...
        public string BillingServiceUrl { get; }
        ...
        private static string GetDbConnectionString(IConfiguration configuration)
        {
            ...
            var dbDatabase = configuration.GetValueOrThrow<string>("CASH_TRANSACTIONS_PG_DATABASE");
            var dbUsername = configuration.GetValueOrThrow<string>("CASH_TRANSACTIONS_PG_USERNAME");
            var dbPassword = configuration.GetValueOrThrow<string>("CASH_TRANSACTIONS_PG_PASSWORD");
