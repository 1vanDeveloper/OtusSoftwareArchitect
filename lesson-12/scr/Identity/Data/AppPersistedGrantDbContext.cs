...
namespace Identity.Data
{
    ...
    {
        /// <inheritdoc />
        public AppPersistedGrantDbContext(DbContextOptions<AppPersistedGrantDbContext> options, OperationalStoreOptions storeOptions) 
        ...
        {
            builder.ApplyConfigurationsFromAssembly(typeof(AppPersistedGrantDbContext).Assembly);
